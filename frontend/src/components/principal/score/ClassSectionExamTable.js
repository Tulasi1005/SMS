  ...
  return (
    <div className="container my-4" style={{
      ...
      style={{
        ...
        <h3 className="text-center mb-3 fw-bold text-white">Class & Section Exam Results</h3>
        ...
        <div className="row mb-3 g-2">
          <div className="col-md-6">
            <label htmlFor="classSelect" className="form-label fw-semibold text-white">
              Select Class
            </label>
            <select
              id="classSelect"
          ...
          <div className="col-md-6">
            <label htmlFor="sectionSelect" className="form-label fw-semibold text-white">
              Select Section
            </label>
            <select
              id="sectionSelect"
