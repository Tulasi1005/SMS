...
const ParentNotification = () => {
  ...
  const styles = {
    ...
    header: { color: '#ffffff', marginBottom: '25px', paddingBottom: '15px', borderBottom: '3px solid #3498db', textShadow: '1px 1px 2px rgba(0,0,0,0.1)', animation: 'slideInFromTop 0.5s ease-out' },
