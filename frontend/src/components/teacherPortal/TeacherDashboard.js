...
const TeacherDashboard = () => {
  ...
  if (!user || !email || !token) {
    return (
      <Box sx={{ textAlign: "center", p: 3, color: "#f5f5f5" }}>
        <Fade in={true}>
      ...
      <Paper
        sx={{
          ...
          "&:before": {
            ...
            height: "100%",
            background:
              "radial-gradient(circle at 20% 30%, rgba(75, 86, 185, 0.5), transparent 60%)",
            pointerEvents: "none",
          },
        }}
      >
                ...
                {timetable.map((slot, index) => (
                  <TableRow
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        backgroundColor: "linear-gradient(135deg, #272d31, #7091E6, #272d31)",
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          borderRadius: "50%",
                          background:
                            "linear-gradient(135deg, #272d31, #7091E6, #272d31)",
                        }}
                      />
                      <Typography
                        sx={{
